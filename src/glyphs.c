...
unsigned char const C_icon_app_bitmap[] = {
  0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xe1, 0xff, 0xe1, 0xff, 0xfc, 0x7f, 0xfc,
  0x47, 0xfe, 0x4f, 0xfe, 0x1f, 0xff, 0x3f, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
};
#ifdef OS_IO_SEPROXYHAL
        #include "os_io_seproxyhal.h"
