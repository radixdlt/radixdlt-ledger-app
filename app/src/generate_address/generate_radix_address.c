...
static generate_radix_address_context_t *ctx = &global.generateRadixAddressContext;
...
static void generate_and_respond_with_radix_address() {
    ...
    int length_of_radix_address_string_b58 = generate_public_address_from_pub_key_and_universe_magic(
        ctx->radix_universe_magic_byte, publicKey.W, G_io_apdu_buffer,
...
void handle_generate_radix_address(uint8_t p1, uint8_t p2, uint8_t *data_buffer,
