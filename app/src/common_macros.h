...
#define MAX_AMOUNT_OF_CACHED_BYTES_BETWEEN_CHUNKS MAX_CHUNK_SIZE // (RADIX_RRI_MAX_BYTE_COUNT - 1)
#define MAX_ATOM_SLICE_SIZE (MAX_AMOUNT_OF_CACHED_BYTES_BETWEEN_CHUNKS + MAX_CHUNK_SIZE)
