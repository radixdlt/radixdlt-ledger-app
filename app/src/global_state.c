...
static void (*generic_void_callback)(void);
...
static unsigned int ui_generic_approve_button(unsigned int button_mask, unsigned int button_mask_counter) {
    return seek_left_right_or_approve(button_mask, button_mask_counter, generic_void_callback);
}

static unsigned int ui_generic_seek_button(unsigned int button_mask, unsigned int button_mask_counter) {
    return reject_or_approve(button_mask, button_mask_counter, generic_void_callback);
}
...
void display_seek_if_needed(
    ...
    os_memcpy(title_row_12_chars, title_row_max_12_chars, 12);
    generic_void_callback = didApproveCallback;
